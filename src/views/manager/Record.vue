  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="userName" label="患者姓名" align="center" show-overflow-tooltip></el-table-column>
        ...
        <el-table-column prop="medicalRecord" label="医嘱病历" align="center">
          <template v-slot="scope">
            <el-button type="primary" size="mini" @click="viewEditor(scope.row.medicalRecord)">查看病历</el-button>
          </template>
        </el-table-column>
        <el-table-column prop="inhospital" align="center" label="是否住院"></el-table-column>
        <el-table-column prop="inhostpitalRecord" align="center" label="是否住院登记"></el-table-column>
    ...
    <el-dialog title="医嘱病例填写" :visible.sync="fromVisible" width="60%"  @close="cancel">

...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'doctorPerson', name: 'DoctorPerson', meta: { name: '医生个人信息' }, component: () => import('../views/manager/DoctorPerson') },
      { path: 'userPerson', name: 'UserPerson', meta: { name: '患者个人信息' }, component: () => import('../views/manager/UserPerson') },
